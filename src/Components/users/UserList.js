    ...
    return (
      ...
      <Table dataSource={this.state.users}>
        ...
        <Column
          ...
          render={(text, record) => (
            <Space size="middle">
              <Button onClick={() => {this.props.history.push(`user/${record.id}/edit`)}}>Edit</Button>
      ...
      <Divider />
        <Button type="primary" onClick={() => this.props.history.push(`user/create`)}>Create New</Button>
      </div>
    );
  }
}
